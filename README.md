...
* [durablefunctionsmonitor.svelte](https://github.com/microsoft/DurableFunctionsMonitor/tree/main/durablefunctionsmonitor.svelte) - client UI implementation. A Svelte 5 app written in TypeScript, built with Vite. Compiled HTML/JS/CSS statics from this project are then served by the backends. See [docs/ui.md](https://github.com/microsoft/DurableFunctionsMonitor/blob/main/docs/ui.md).
